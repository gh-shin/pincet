...
public final class VmStatBuilder {
  ...
  public VmStat build() {
    return new VmStat(
        success, msg, osName, version, processors,
        loadAvg, sysCpuLoad, procCpuLoad, totalThreads,
        totalDaemonThreads, deadLocks, freePhysicalMemSize, totalPhysicalMemSize,
        freeSwapSize, totalSwapSize, compiler, committedVMsize,
        heapInit, heapCommitted, heapMax, heapUsed,
        nonHeapInit, nonHeapCommitted, nonHeapMax, nonHeapUsed
    );
  }
}
